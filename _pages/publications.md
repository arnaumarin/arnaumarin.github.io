...
title: "Publications"
excerpt: "Selected publications by Arnau Marin-Llobet"
author_profile: true
---

<p style="margin-bottom: 1.4em; color: #666; font-size: 0.92em;">
...
(*) denotes equal contribution. If you cannot access any of them, just email me and I will be happy to share.
</p>
...
<ul class="pub-list pub-list-large">
  ...
  <li class="pub-item">
    <div class="pub-thumb"><img src="/images/pub/mecp2.png" alt="" onerror="this.style.display='none'"></div>
    <div class="pub-content">
      <div class="pub-title"><strong>MECP2 and SH3KBP1 variants associated with autism spectrum disorder and immune dysregulation.</strong></div>
      <div class="pub-authors"><strong>A. Marin-Llobet</strong>, C. Hernando-Davalillo, H. Baide Mairena, P. Llobet-Agullo et al.</div>
      <div class="pub-venue"><em>Frontiers in Immunology</em>, 17:1814088, 2026.</div>
      <div class="pub-meta-row">
        <span class="pub-links"><a class="pub-link" href="https://www.frontiersin.org/journals/immunology/articles/10.3389/fimmu.2026.1814088/full">Paper</a><button class="pub-link tldr-btn" type="button">TL;DR</button></span>
        <span class="pub-tags"><span class="pub-tag tag-genomics">Genomics</span></span>
      </div>
      <div class="pub-tldr">Two boys with autism, immune dysregulation, and congenital cardiac anomalies, each carrying a distinct X-chromosome copy-number variant (an <em>MECP2</em> duplication and an <em>SH3KBP1</em> variant) &mdash; a case for joint genetic&ndash;immune workups in ASD.</div>
    </div>
  </li>
  ...
  <li class="pub-item">
    ...
    <div class="pub-content">
      ...
      <div class="pub-authors"><strong>A. Marin-Llobet</strong>, Z. Lin, J. Baek et al.</div>
      <div class="pub-venue">Under peer review. Preprint in <em>bioRxiv</em>, 2025.</div>
      <div class="pub-meta-row">
        <span class="pub-links"><a class="pub-link" href="https://www.biorxiv.org/content/10.1101/2025.09.11.675660v1">Preprint</a><button class="pub-link tldr-btn" type="button">TL;DR</button></span>
  ...
  <li class="pub-item">
    ...
    <div class="pub-content">
      <div class="pub-title"><strong>Spike sorting AI agent.</strong></div>
      <div class="pub-authors">Z. Lin* and <strong>A. Marin-Llobet</strong>* et al.</div>
      <div class="pub-venue">Under peer review. Preprint in <em>bioRxiv</em>, 2025.</div>
      <div class="pub-meta-row">
        <span class="pub-links"><a class="pub-link" href="https://www.biorxiv.org/content/10.1101/2025.02.11.637754v1">Preprint</a><a class="pub-link" href="https://github.com/spikeagent/spikeagent">GitHub</a><button class="pub-link tldr-btn" type="button">TL;DR</button></span>
        <span class="pub-tags"><span class="pub-tag tag-neuro">Neuroscience</span><span class="pub-tag tag-ai4sci">AI for Discovery</span></span>
      </div>
      <div class="pub-tldr">A multimodal LLM agent that automates the full spike-sorting workflow &mdash; preprocessing, sorting, and visual curation &mdash; with step-by-step reasoning a human can audit.</div>
    </div>
  </li>
