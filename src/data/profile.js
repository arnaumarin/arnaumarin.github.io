...
export const bioHtml = [
  ...
  `I am mostly interested in <span class="accent">understanding minds</span>, both biological and
   artificial: how they work, how they represent the world, and how they make decisions. Today that
   means working on AI, building <span class="accent">autonomous agents</span> and studying the
   <span class="accent">Interpretability</span> of language models to support
   <span class="accent">safer and more reliable AI systems</span>. I came to this from
   <span class="accent">computational neuroscience</span> and <span class="accent">learning</span>,
   where I developed AI-based methods to open the black box of the brain.`,
]
