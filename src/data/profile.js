...
export const bioHtml = [
  ...
  `I am mostly interested in <span class="accent">computational neuroscience</span>: opening the
   <span class="accent">black box of the brain</span> to understand how it works and how it makes
   decisions, at both the <span class="accent">cognitive</span> and the
   <span class="accent">mechanistic</span> level. To do that, I build
   <span class="accent">autonomous agents</span> and other <span class="accent">AI-based methods</span>
   that help me probe the brain and make sense of it. More recently, I have been turning these same
   tools onto AI itself, working on the <span class="accent">Interpretability</span> of language models
   to support <span class="accent">safer and more reliable AI systems</span>.`,
]
