...
export default [
  // ── DL & Interpretability / AI safety ───────────────────────────
  {
    ...
    venueHtml: 'Preprint, <em>EMNLP</em>. Oral talk at the <em>HOW Workshop, CVPR</em> 2026.',
  ...
  },
  {
    ...
    venueHtml: '<em>ICML 2026 AIWILD Workshop</em>. Preprint, <em>COLM</em> 2026.',
  ...
  },
  {
    ...
    venueHtml: 'Preprint, <em>EMNLP</em>.',
    tags: [{ label: 'DL & Interp.', type: 'dl' }],
    cats: ['dl'],
    links: [],
  },
  {
    ...
    venueHtml: 'Preprint, <em>NeurIPS</em>.',
    tags: [{ label: 'DL & Interp.', type: 'dl' }],
    cats: ['dl'],
    links: [],
  },
  ...
  // ── AI Agents for Automated Scientific Discovery ────────────────
  {
    ...
    venueHtml: '<em>Nature Neuroscience</em>, in press, 2026.',
  ...
  },
  {
    ...
    venueHtml: 'Preprint, <em>Nature Communications</em>, 2024.',
    tags: [{ label: 'Neuroscience', type: 'neuro' }],
    cats: ['neuro'],
    links: [],
  },
